...
namespace RaumiDiscord.Core.Server.DeltaRaumi.Database.Migrations
{
    ...
    [Migration("20250711213115_UserMentionRatelimit-new")]
    partial class UserMentionRatelimitnew
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RaumiDiscord.Core.Server.Api.Models.MentionedUsers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("UserGuildStatsModelStatUlid")
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("UserGuildStatsModelStatUlid");

                    b.ToTable("MentionedUsers");
                });
            ...
            modelBuilder.Entity("RaumiDiscord.Core.Server.Api.Models.MentionedUsers", b =>
                {
                    b.HasOne("RaumiDiscord.Core.Server.Api.Models.UserGuildStatsModel", null)
                        .WithMany("Mentioneds")
                        .HasForeignKey("UserGuildStatsModelStatUlid");
                });
